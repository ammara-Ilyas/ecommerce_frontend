    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-md sm:text-center">
          <h2 className="text-3xl  text-left pl-28 pb-5 font-bold tracking-tight text-gray-900">
            Sign up for our newsletter
          </h2>
          <p className="mx-auto  max-w-2xl font-light text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400">
          ...
          <form action="#">
            ...
            <div className="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300">
              ...
              <Link
                href="/contact"
                className="font-medium text-blue-500 dark:text-primary-500 hover:underline"
              >
